...
export function createDemoData(): AppData {
  ...
  return {
    characterRelations: [
      {
        id: "demo-relation-elara-linwanxing",
        projectId: DEMO_PROJECT_ID,
        fromCharacterId: "demo-entry-character-elara",
        toCharacterId: DEMO_ENTRY_IDS.character,
        relationType: "mentor",
        customLabel: "导师 / 推荐人",
        direction: "directed",
        status: "current",
        note: "艾拉是林晚星的入学推荐人与符文学导师，她相信林晚星的天赋不应被出身限制。",
        createdAt: projectCreated,
        updatedAt: now,
      },
      {
        id: "demo-relation-linwanxing-sorin",
        projectId: DEMO_PROJECT_ID,
        fromCharacterId: DEMO_ENTRY_IDS.character,
        toCharacterId: "demo-entry-character-sorin",
        relationType: "rival",
        customLabel: "竞争对手",
        direction: "mutual",
        status: "current",
        note: "两人同为符文学徒，却来自完全不同的阶层。索林最初轻视林晚星，后来逐渐被她的直觉与坚持动摇。",
        createdAt: projectCreated,
        updatedAt: now,
      },
      {
        id: "demo-relation-linwanxing-kane",
        projectId: DEMO_PROJECT_ID,
        fromCharacterId: DEMO_ENTRY_IDS.character,
        toCharacterId: "demo-entry-character-kane",
        relationType: "ally",
        customLabel: "潜在盟友",
        direction: "mutual",
        status: "ambiguous",
        note: "两人同为平民出身，却分别走向学院与边境抗争。当前尚未正式相识，但他们的目标在霜线冲突中可能交汇。",
        createdAt: projectCreated,
        updatedAt: now,
      },
      {
        id: "demo-relation-sorin-elara",
        projectId: DEMO_PROJECT_ID,
        fromCharacterId: "demo-entry-character-sorin",
        toCharacterId: "demo-entry-character-elara",
        relationType: "colleague",
        customLabel: "学院同僚 / 立场分歧",
        direction: "mutual",
        status: "ambiguous",
        note: "两人都在学院体系内活动，但艾拉主张知识开放，索林则受守序会与贵族传统影响，二人在林晚星问题上存在明显分歧。",
        createdAt: projectCreated,
        updatedAt: now,
      },
      {
        id: "demo-relation-sorin-kane",
        projectId: DEMO_PROJECT_ID,
        fromCharacterId: "demo-entry-character-sorin",
        toCharacterId: "demo-entry-character-kane",
        relationType: "enemy",
        ...
        direction: "mutual",
        status: "current",
        note: "索林代表守序会的执律秩序，凯恩则站在边境矿工与北境联盟一侧。两人的冲突体现了浮空岛秩序与边境平民抗争之间的对立。",
        createdAt: projectCreated,
        updatedAt: now,
      },
    ],
